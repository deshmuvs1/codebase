...
test ('loginpage', async () => {
    ...
    // network call come to idle state  //flaky 
...
test ('loginpage1', async () => {
    ...
    const shop = page.locator(".card-body b");
    const coat  = "ZARA COAT 3" 

    const title =  await shop.allTextContents();
    console.log(title);
